...
const options = [
    ...
    },
    {
        ...
        type: 'string',
        allowedValues: platform_1.getPlatformList(),
        default: platforms_1.PLATFORM_TYPE_GITHUB,
        admin: true,
    },
    {
        name: 'endpoint',
    ...
    },
    {
        ...
        type: 'string',
        allowedValues: versioning_1.getVersioningList(),
    ...
    {
        name: 'matchStrings',
        description: 'Regex capture rule to use. Valid only within `regexManagers` object.',
        type: 'array',
        subType: 'string',
        format: 'regex',
    ...
    },
    {
        ...
        description: 'Optional depName for extracted dependencies. Valid only within `regexManagers` object.',
        type: 'string',
        parent: 'regexManagers',
        cli: false,
        env: false,
    },
    {
        ...
        description: 'Optional lookupName for extracted dependencies, else defaults to depName value. Valid only within `regexManagers` object.',
        type: 'string',
        parent: 'regexManagers',
        cli: false,
        env: false,
    },
    {
        ...
        description: 'Optional datasource for extracted dependencies. Valid only within `regexManagers` object.',
        type: 'string',
        parent: 'regexManagers',
        cli: false,
        env: false,
    },
    {
        ...
        description: 'Optional versioning for extracted dependencies. Valid only within `regexManagers` object.',
        type: 'string',
        parent: 'regexManagers',
        cli: false,
        env: false,
...
function loadManagerOptions() {
    for (const [name, config] of manager_1.getManagers().entries()) {
