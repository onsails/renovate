...
const definitions_1 = require("../lib/config/definitions");
const options = definitions_1.getOptions();
describe('docs', () => {
    const doc = fs_1.default.readFileSync('docs/usage/configuration-options.md', 'utf8');
    const selfHostDoc = fs_1.default.readFileSync('docs/usage/self-hosted-configuration.md', 'utf8');
    const headers = doc
        .match(/\n## (.*?)\n/g)
    ...
    const relatedOptionsMatrix = options
        ...
        .sort();
    let relatedOptions = [].concat(...relatedOptionsMatrix); // Converts the matrix to an 1D array
...
//# sourceMappingURL=website-docs.spec.js.map