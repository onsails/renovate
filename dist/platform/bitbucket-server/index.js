...
async function getJsonFile(fileName) {
    try {
        const { body } = await bitbucketServerHttp.getJson(`./rest/api/1.0/projects/${config.projectKey}/repos/${config.repositorySlug}/browse/${fileName}?limit=20000`);
        if (!body.isLastPage) {
            logger_1.logger.warn({ size: body.size }, `The file is too big`);
        }
        else {
...
async function createPr({ sourceBranch, targetBranch, prTitle: title, prBody: rawDescription, platformOptions, }) {
    ...
    try {
        ...
        if (((_c = (_b = (_a = err.body) === null || _a === void 0 ? void 0 : _a.errors) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.exceptionName) ===
            ...
            await git_1.deleteBranch(sourceBranch);
            throw new Error(error_messages_1.REPOSITORY_CHANGED);
        }
        throw err;
    }
