import { BranchStatus, PrState, VulnerabilityAlert as _VulnerabilityAlert } from '../types';
export declare type VulnerabilityAlert = _VulnerabilityAlert;
...
export interface Platform {
    ...
    getBranchStatus(branchName: string, requiredStatusChecks?: string[] | null): Promise<BranchStatus>;
