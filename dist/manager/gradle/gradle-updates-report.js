...
gradle.buildFinished {
   ...
   outputFile.write json
    ...
    const gradleInitFile = upath_1.join(localDir, 'renovate-plugin.gradle');
...
async function readGradleReport(localDir) {
    const renovateReportFilename = upath_1.join(localDir, exports.GRADLE_DEPENDENCY_REPORT_FILENAME);
