...
const content = fs_1.readFileSync(upath_1.resolve('lib/manager/bazel/__fixtures__/WORKSPACE1'), 'utf8');
const contentContainerPull = fs_1.readFileSync(upath_1.resolve('lib/manager/bazel/__fixtures__/container_pull'), 'utf8');
...
describe('manager/bazel/update', () => {
    describe('updateDependency', () => {
        ...
        it('updates tag', async () => {
            ...
            const res = await update_1.updateDependency({
                fileContent: content,
                upgrade,
            });
        ...
        it('updates container_pull deptype and preserves comment', async () => {
          ...
          tag="v1.0.0-alpha31.cli-migrations"
                ...
                newDigest: 'sha256:2c29ba015faef92a3f55b37632fc373a7fbc2c9fddd31e317bf07113391c640b',
...
`,
            ...
            expect(res).toMatchSnapshot();
            expect(res).not.toEqual(content);
            expect(res).toContain('"aaa09d789f3dba190787f8b4454c7d3c936fe123",  # v1.0.3');
        });
        it('updates commit-based http archive', async () => {
            ...
            httpMock
                ...
                .get('/GoogleContainerTools/distroless/archive/033387ac8853e6cc1cd47df6c346bc53cbc490d8.tar.gz')
