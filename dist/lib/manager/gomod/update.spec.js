...
describe('manager/gomod/update', () => {
    describe('updateDependency', () => {
        it('replaces existing value', () => {
            ...
            const res = update_1.updateDependency({ fileContent: gomod1, upgrade });
        ...
        it('replaces two values in one file', () => {
            ...
            const res1 = update_1.updateDependency({
                fileContent: gomod1,
                upgrade: upgrade1,
            });
            ...
            const res2 = update_1.updateDependency({
                fileContent: res1,
                upgrade: upgrade2,
            });
        ...
        it('returns null if error', () => {
            const res = update_1.updateDependency({ fileContent: null, upgrade: null });
            expect(res).toBeNull();
        });
        it('replaces multiline', () => {
            ...
            const res = update_1.updateDependency({ fileContent: gomod2, upgrade });
            expect(res).not.toEqual(gomod2);
            expect(res).toContain(upgrade.newValue);
        });
