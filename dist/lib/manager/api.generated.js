...
const azurePipelines = __importStar(require("./azure-pipelines"));
const batect = __importStar(require("./batect"));
const batectWrapper = __importStar(require("./batect-wrapper"));
...
const gradleLite = __importStar(require("./gradle-lite"));
...
const preCommit = __importStar(require("./pre-commit"));
...
const setupCfg = __importStar(require("./setup-cfg"));
const swift = __importStar(require("./swift"));
const terraform = __importStar(require("./terraform"));
const terraformVersion = __importStar(require("./terraform-version"));
const terragrunt = __importStar(require("./terragrunt"));
