...
exports.analyseTerragruntModule = exports.extractTerragruntModule = void 0;
...
const datasourceTerragruntModule = __importStar(require("../../datasource/terraform-module"));
...
function extractTerragruntModule(startingLine, lines) {
    ...
    const result = providers_1.extractTerragruntProvider(startingLine, lines, moduleName);
    result.dependencies.forEach((dep) => {
        // eslint-disable-next-line no-param-reassign
        dep.managerData.terragruntDependencyType =
            util_1.TerragruntDependencyTypes.terragrunt;
    });
    return result;
}
