...
function detectMonorepos(packageFiles) {
    ...
    for (const p of packageFiles) {
        ...
        const basePath = upath_1.default.dirname(packageFile);
        ...
        if (packages === null || packages === void 0 ? void 0 : packages.length) {
            ...
            const internalPackageFiles = packageFiles.filter((sp) => matchesAnyPattern(upath_1.default.dirname(sp.packageFile), internalPackagePatterns));
