...
describe('pep440.isValid(input)', () => {
    it('should support a version without equals', () => {
        expect(_1.default.isValid('0.750')).toBeTruthy();
        expect(_1.default.isValid('1.2.3')).toBeTruthy();
    });
    it('should support irregular versions', () => {
        expect(_1.default.isValid('17.04.0')).toBeTruthy();
    });
    it('should support simple pep440', () => {
        expect(_1.default.isValid('==1.2.3')).toBeTruthy();
    });
    it('should support pep440 with RC', () => {
        expect(_1.default.isValid('==1.2.3rc0')).toBeTruthy();
    });
    it('should support ranges', () => {
        expect(_1.default.isValid('~=1.2.3')).toBeTruthy();
        expect(_1.default.isValid('==1.2.*')).toBeTruthy();
        expect(_1.default.isValid('>1.2.3')).toBeTruthy();
    });
...
describe('pep440.isStable(version)', () => {
    it('returns correct value', () => {
        expect(_1.default.isStable('1.2.3')).toBeTruthy();
        expect(_1.default.isStable('1.2.3rc0')).toBeFalsy();
    });
    it('returns false when version invalid', () => {
        expect(_1.default.isStable('not_version')).toBeFalsy();
    });
});
describe('pep440.isSingleVersion()', () => {
    it('returns true if naked version', () => {
        expect(_1.default.isSingleVersion('1.2.3')).toBeTruthy();
        expect(_1.default.isSingleVersion('1.2.3rc0')).toBeTruthy();
    });
    it('returns true if double equals', () => {
        expect(_1.default.isSingleVersion('==1.2.3')).toBeTruthy();
        expect(_1.default.isSingleVersion('==1.2')).toBeTruthy();
        expect(_1.default.isSingleVersion('== 1.2.3')).toBeTruthy();
    });
    it('returns false when not version', () => {
        expect(_1.default.isSingleVersion('==1.*')).toBeFalsy();
    });
});
const versions = [
    '0.9.4',
...
describe('pep440.getSatisfyingVersion(versions, range)', () => {
    it('returns correct value', () => {
        expect(_1.default.getSatisfyingVersion(versions, '~=1.2.1')).toBe('1.2.3');
    });
    it('returns null when none found', () => {
        expect(_1.default.getSatisfyingVersion(versions, '~=2.1')).toBeNull();
    });
});
describe('pep440.minSatisfyingVersion(versions, range)', () => {
    it('returns correct value', () => {
        expect(_1.default.minSatisfyingVersion(versions, '~=1.2.1')).toBe('1.2.1');
    });
    it('returns null when none found', () => {
        expect(_1.default.minSatisfyingVersion(versions, '~=2.1')).toBeNull();
    });
});
describe('pep440.getNewValue()', () => {
    const { getNewValue } = _1.default;
    ...
    [
        ...
        const needReplace = _1.default.matches('1.2.3', currentValue);
