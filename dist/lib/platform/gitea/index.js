...
exports.updatePr = exports.setBranchStatus = exports.mergePr = exports.initRepo = exports.initPlatform = exports.getVulnerabilityAlerts = exports.getRepos = exports.getRepoForceRebase = exports.getPrList = exports.getPrBody = exports.getPr = exports.getIssueList = exports.getJsonFile = exports.getBranchStatusCheck = exports.getBranchStatus = exports.getBranchPr = exports.findPr = exports.findIssue = exports.ensureIssueClosing = exports.ensureIssue = exports.ensureCommentRemoval = exports.ensureComment = exports.deleteLabel = exports.createPr = exports.addReviewers = exports.addAssignees = void 0;
...
const platform = {
    ...
    async getJsonFile(fileName) {
        try {
            const contents = await helper.getRepoContents(config.repository, fileName, config.defaultBranch);
    ...
    async initRepo({ repository, localDir, cloneSubmodules, }) {
        var _a, _b;
        let repo;
        config = {};
    ...
    async ensureIssue({ title, reuseTitle, body: content, shouldReOpen, once, }) {
        logger_1.logger.debug(`ensureIssue(${title})`);
        try {
            const body = utils_1.smartLinks(content);
            const issueList = await platform.getIssueList();
    ...
    getPrBody(prBody) {
        return pr_body_1.smartTruncate(utils_1.smartLinks(prBody), 1000000);
    },
