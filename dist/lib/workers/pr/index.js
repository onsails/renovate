...
exports.checkAutoMerge = exports.ensurePr = exports.getPlatformPrOptions = exports.addAssigneesReviewers = void 0;
    ...
    try {
        ...
        try {
            ...
            if (config.dryRun) {
                ...
                if (!dependencyDashboardCheck && limits_1.isLimitReached(limits_1.Limit.PullRequests)) {
                    return { prResult: common_1.PrResult.LimitReached };
                }
                ...
                limits_1.incLimitedValue(limits_1.Limit.PullRequests);
