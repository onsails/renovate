...
import { GroupConfig, RenovateAdminConfig, RenovateConfig, RenovateSharedConfig, ValidationMessage } from '../config';
import { Release } from '../datasource';
import { ArtifactError, LookupUpdate, PackageDependency, PackageFile } from '../manager/common';
...
export declare enum ProcessBranchResult {
...
export interface BranchConfig extends BranchUpgradeConfig, RenovateAdminConfig, PlatformPrOptions {
